...
#define MY_UUID {0x0A, 0x3B, 0x2A, 0x35, 0x3B, 0x40, 0x4B, 0xDC, 0xD3, 0x69, 0xDE, 0x9F, 0xF4, 0x4A, 0x81, 0x88}
PBL_APP_INFO(MY_UUID, "Gatekeeper-I", "Mr. Humphreys", 0x1, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
...
void second_display_layer_update_callback(Layer *me, GContext* ctx) {
  ...
  //This doesn't do anything but it was already here, so I'll just leave it.
  graphics_context_set_fill_color(ctx, GColorBlack);

  //This does work. Leave it.
