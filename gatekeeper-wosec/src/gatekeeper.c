...
#define MY_UUID {0x0A, 0x3B, 0x2A, 0x35, 0x3C, 0x40, 0x4B, 0xDC, 0xD3, 0x69, 0xDE, 0x9F, 0xF4, 0x4A, 0x81, 0x88}
PBL_APP_INFO(MY_UUID, "Gatekeeper-W", "Mr. Humphreys", 0x1, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
